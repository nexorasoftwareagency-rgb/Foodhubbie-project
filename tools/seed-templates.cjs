...
const templates = {
  pizza: {
    ...
    defaults: {
      ...
      categories: {
        starters: { name: 'Starters', order: 1 },
        pizzas: { name: 'Pizzas', order: 2 },
        beverages: { name: 'Beverages', order: 3 },
        desserts: { name: 'Desserts', order: 4 },
      },
      // Dishes reference categories by NAME (the apps match d.category against
      // category.name). Fixed keys are fine — the admin's dish id is cosmetic.
      dishes: {
        d1: { name: 'Garlic Breadsticks', category: 'Starters', price: 99, stock: true, order: 1 },
        d2: { name: 'Cheesy Garlic Bread', category: 'Starters', price: 129, stock: true, order: 2 },
        d3: { name: 'Chicken Wings (6 pcs)', category: 'Starters', price: 199, stock: true, order: 3 },
        d4: { name: 'Margherita Pizza', category: 'Pizzas', price: 149, stock: true, order: 1, sizes: { Small: 149, Medium: 249, Large: 349 } },
        d5: { name: 'Pepperoni Pizza', category: 'Pizzas', price: 249, stock: true, order: 2, sizes: { Small: 249, Medium: 349, Large: 449 } },
        d6: { name: 'Farmhouse Pizza', category: 'Pizzas', price: 299, stock: true, order: 3, sizes: { Small: 299, Medium: 399, Large: 499 } },
        d7: { name: 'BBQ Chicken Pizza', category: 'Pizzas', price: 329, stock: true, order: 4, sizes: { Small: 329, Medium: 429, Large: 529 } },
        d8: { name: 'Cola', category: 'Beverages', price: 60, stock: true, order: 1 },
        d9: { name: 'Fresh Lime Soda', category: 'Beverages', price: 70, stock: true, order: 2 },
