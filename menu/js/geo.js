 ...
 * Verbatim copy of shared/geo/geo.js — the delivery webview is served from
 * the `menu/` hosting root (no build step), so it can't reach shared/ at
 * runtime. This mirrors how the rest of the menu app keeps its deps local.
 */
