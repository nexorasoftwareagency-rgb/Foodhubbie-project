...
- **Home IP is dynamic**: SSH times out when the ISP changes it. Authoritative process: check `https://api.ipify.org`, add `/32` to SG `sg-0a5a73df4b5d37b38` (AWS CLI command in `Credentials/SERVER-ACCESS-GUIDE.md`).
